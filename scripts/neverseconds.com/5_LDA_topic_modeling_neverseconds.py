...
#insert an if __name__ == '__main__': in the main module to avoid creating subprocesses recursively
if __name__ ==  '__main__':
	...
	pyLDAvis.show(lda_vis, local=False) #local=False solves the missing file error