...
#Create directory 'jake final'
os.mkdir('jake scrape/jake final')
#Define years of blogging activity
years=['2009','2010','2011','2012','2013','2014','2015','2016']
for year in years:
	#Read .csv files of scraped post's content for each year as dataframe 
	df = pd.read_csv('jake scrape/jake_scrape_{0}.csv'.format(year))
	...
	csv_file = open('jake scrape/jake final/jake_{0}_headline_polarity.csv'.format(year), 'w', newline='', encoding='utf-8')
